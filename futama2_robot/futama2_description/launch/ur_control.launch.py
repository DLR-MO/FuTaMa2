    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("futama2_description"), "urdf", "robot.urdf.xacro"]),
            " ",
            "ros_control_active:=",
            "active",
            " " "robot_ip:=",
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[robot_description, {"publish_frequency": 250.0}],
                extra_arguments=[
                    {"use_intra_process_comms": False}
                ],  # todo set to true when following PR is merged https://github.com/ros2/rclcpp/pull/2303
            )
        ],
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument("launch_dashboard_client",
                              default_value="true", description="Launch Dashboard Client?")
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            "use_tool_communication",
