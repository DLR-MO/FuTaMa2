...
namespace futama2_moveit_config
{
  ...
  public:
        ...
        : Node("planning_scene_publisher_insp_obj", options)
    {
      ...
      // this->declare_parameter("insp_mode", rclcpp::PARAMETER_STRING); // TODO not working when added
      ...
      // // TODO not working when added:
      //rclcpp::Parameter insp_mode_param = this->get_parameter("insp_mode");
      //std::string insp_mode = insp_mode_param.as_string();

      // Load the collision scene asynchronously
      
      // collision_pub_thread_ = std::thread([this, mode, insp_mode]() // TODO not working when added
      collision_pub_thread_ = std::thread([this, mode]()
      {
        ...
        // TODO not working when if added
        //if(insp_mode == "auto_oip")
        //{
          // ----------------- OIP INSP. OBJ. ------------------------------------------
    ...
    }); // end collision_pub_thread_
  } // end PlanningScenePublisher Node
